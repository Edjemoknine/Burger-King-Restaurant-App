...
const PageDetails = ({ params: { id } }: { params: any }) => {
  ...
  const RelatedPro = related?.filter(
    (pro: any) =>
      pro.title.toLowerCase().includes(data?.title.toLowerCase()) &&
      pro.id !== id
  );
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={() =>
                    dispatch(
                      addProduct({ ...data, quantity, size, slug } as any)
                    )
                  }
        ...
        <div className=" my-20">
          ...
          <div>
            ...
            >
              ...
              pariatur nulla ducimus, qui quidem culpa fugiat sit illo
              cupiditate explicabo assumenda aliquam?
            </div>
            <div
